          ...
          <SwiperSlide key={index}>
            <div className="relative w-full h-full flex items-center justify-center px-4 sm:px-6">
              ...
              <motion.div
                ...
                className={`relative mt-[60px] md:mt-[20px] h-auto max-h-[60%] md:h-110 z-10 bg-[#FFFFFF]/90 md:bg-[#FFFFFF]/70 p-4 md:p-8 max-w-4xl w-full mx-4 rounded-lg shadow-lg ${index >= 2 ? 'overflow-y-hidden' : 'overflow-y-auto'}`}
              >
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center font-Grown text-[#1F3A93] mb-2 md:mb-4">
                  {slide.title}
                </h2>
